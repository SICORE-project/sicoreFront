<?php $__env->startSection('title', 'SICORE - Avance Tabaski'); ?>
...
<?php $component = App\View\Components\ModulePage::resolve(['slug' => 'paie-avance-tabaski'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Baye Saliou DIAW\Downloads\SICORE-Frontend-Laravel12-Mode-Test-Complet\sicore-front-laravel-mode-test\resources\views/pages/paie/avance-tabaski.blade.php ENDPATH**/ ?>