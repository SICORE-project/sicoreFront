...
<?php endif; ?>
    ...
    <section class="content-area">
        <?php if(!empty($permissionsError)): ?>
            <div class="alert alert-danger"><?php echo e($permissionsError); ?></div>
        <?php endif; ?>
        <!-- Objectifs métier -->
                        ...
                        <tr data-module="<?php echo e($permission['module'] ?? ''); ?>" data-permission="<?php echo e($permission['nom'] ?? ''); ?>">
                            ...
                            <td class="actions-cell">
                                <div class="table-actions-inline">
                                    <a href="<?php echo e(route('admin.permissions.show', $permission['id'])); ?>" class="table-action">Voir</a>
                                    <a href="<?php echo e(route('admin.permissions.edit', $permission['id'])); ?>" class="table-action">Modifier</a>
                    ...
                    <?php $__currentLoopData = $permissions['links']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $link): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if($link['url']): ?>
                            <a href="<?php echo e($link['url']); ?>" class="page-btn <?php echo e($link['active'] ? 'active' : ''); ?>">
                                <?php echo e($loop->first ? '←' : ($loop->last ? '→' : $link['label'])); ?>

                            </a>
                        <?php else: ?>
                            <span class="page-btn disabled"><?php echo e($loop->first ? '←' : ($loop->last ? '→' : $link['label'])); ?></span>
                        <?php endif; ?>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <?php else: ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\projets\sicoreFront\resources\views\pages\administration\permissions.blade.php ENDPATH**/ ?>