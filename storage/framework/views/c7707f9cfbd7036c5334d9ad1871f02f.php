                                ...
                                <tr data-niveau="<?php echo e($role['niveau'] ?? ''); ?>" data-statut="<?php echo e(($role['est_actif'] ?? false) ? '1' : '0'); ?>">
                                    ...
                                    <td class="actions-cell">
                                        <div class="table-actions-inline">
                                            <a href="<?php echo e(route('admin.roles.show', $role['id'])); ?>" class="table-action">Voir</a>
                                            <a href="<?php echo e(route('admin.roles.edit', $role['id'])); ?>" class="table-action">Modifier</a>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\projets\sicoreFront\resources\views\pages\administration\profils-roles.blade.php ENDPATH**/ ?>