      ...
      <div class="actions-group">
        <?php $__currentLoopData = ($page['actions'] ?? []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          ...
          <?php if($isNewUserButton): ?>
            <a class="<?php echo e($actionClass); ?>" href="<?php echo e(route('utilisateurs.create')); ?>"><?php echo e($actionText); ?></a>
...
<?php /**PATH C:\laragon\www\SICORE\sicoreFront\resources\views/components/module-page.blade.php ENDPATH**/ ?>