<?php $__env->startSection('title', 'SICORE - Nouvelle convocation'); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.topbar','data' => ['title' => 'Nouvelle convocation','subtitle' => 'Indemnites > Convocations > Nouvelle convocation','icon' => 'fa-solid fa-envelope-open-text']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Nouvelle convocation','subtitle' => 'Indemnites > Convocations > Nouvelle convocation','icon' => 'fa-solid fa-envelope-open-text']); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.module-indemnite','data' => ['type' => 'statut-convocation','statut' => 'brouillon']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'statut-convocation','statut' => 'brouillon']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
        ...
        <form
            ...
            role="form"
            method="POST"
            action="<?php echo e(route('indemnites.convocations.store')); ?>"
                            ...
                            >
                                ...
                                <?php $__currentLoopData = $typesConvocation ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option
                                        ...
                                        <?php if((string) old('type_convocation_id') === (string) $type['id']): echo 'selected'; endif; ?>
                                    >
...
unset($__errorArgs, $__bag); ?>"
                                ...
                                name="date_emission"
                                type="date"
                                value="<?php echo e(old('date_emission', date('Y-m-d'))); ?>"
                                required
                            >
...
unset($__errorArgs, $__bag); ?>" id="statut" name="statut">
                                <?php $__currentLoopData = ['brouillon' => 'Brouillon', 'emise' => 'Émise', 'envoyee' => 'Envoyée', 'cloturee' => 'Clôturée']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($value); ?>" <?php if(old('statut', 'brouillon') === $value): echo 'selected'; endif; ?>>
                                        <?php echo e($label); ?>
...
unset($__errorArgs, $__bag); ?>"
                                ...
                                name="heure_debut"
                                type="time"
                                value="<?php echo e(old('heure_debut', '08:00')); ?>"
                                required
                            >
...
unset($__errorArgs, $__bag); ?>"
                                ...
                                name="lieu_examen"
                                type="text"
                                value="<?php echo e(old('lieu_examen')); ?>"
                            >
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-actions">
                <a class="btn-secondary" href="<?php echo e(route('indemnites.convocations')); ?>" data-wizard-cancel>
                    Annuler
                </a>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\projets\sicoreFront\resources\views\pages\indemnites\convocations\create.blade.php ENDPATH**/ ?>