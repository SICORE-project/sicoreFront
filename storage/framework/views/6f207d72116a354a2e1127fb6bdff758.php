...
unset($__errorArgs, $__bag); ?>" id="password" type="password" name="password" placeholder="Votre mot de passe" autocomplete="current-password" required>
          ...
          <p class="demo-credentials">
            Mode test : <strong><?php echo e(config('sicore.test.email')); ?></strong> / <strong><?php echo e(config('sicore.test.password')); ?></strong>
          </p>
        </div>
      </div>
    </section>
...
<?php echo $__env->make('layouts.guest', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Baye Saliou DIAW\Downloads\SICORE-Frontend-Laravel12-Mode-Test-Complet\sicore-front-laravel-mode-test\resources\views/pages/auth/login.blade.php ENDPATH**/ ?>