...
<?php $__env->startSection('title', 'SICORE - Edition des salaires par banque'); ?>
...
<?php $component = App\View\Components\ModulePage::resolve(['slug' => 'paie-edition-salaires-banque'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\projets\sicoreFront\resources\views\pages\paie\edition-salaires-banque.blade.php ENDPATH**/ ?>