<form class="teacher-form" action="{{ route('parametres.syndicats.store') }}" method="POST" data-syndicat-form data-uniqueness-url="{{ route('parametres.syndicats.check-uniqueness') }}">
  ...
  <div class="form-grid form-grid--balanced">
    ...
    <div class="form-group">
      ...
      <input class="form-control @error('libelle') is-invalid @enderror" id="libelle" name="libelle" type="text" value="{{ old('libelle') }}" maxlength="100" placeholder="Ex. Syndicat des enseignants" required data-unique-field aria-describedby="libelle-feedback">
    ...
    <div class="form-group">
      ...
      <input class="form-control @error('montant_check_off') is-invalid @enderror" id="montant_check_off" name="montant_check_off" type="number" value="{{ old('montant_check_off') }}" min="0" max="9999999999.99" step="0.01" inputmode="decimal" placeholder="Ex. 1500">
    ...
    <div class="form-group">
      ...
      <input class="form-control @error('montant_oeuvre_sociale') is-invalid @enderror" id="montant_oeuvre_sociale" name="montant_oeuvre_sociale" type="number" value="{{ old('montant_oeuvre_sociale') }}" min="0" max="9999999999.99" step="0.01" inputmode="decimal" placeholder="Ex. 1000">
