...
<main class="main-content">
  ...
  <section class="content-area">
    ...
    <div class="actions-row"><p class="breadcrumb"><a href="{{ route('parametres.index') }}">Paramétrage</a> &gt; Corps</p><div class="actions-group"><button class="btn-primary" type="button" data-modal-open="corps-create-modal">+ Nouveau corps</button></div></div>
