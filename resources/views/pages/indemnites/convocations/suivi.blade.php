                ...
                <tbody>
                    @forelse ($envois as $envoi)
                        @php
                            ...
                            [$envoiBadgeClass, $envoiBadgeLabel] = $envoiBadges[$envoi['statut'] ?? null]
                                ?? ['badge-pending', ucfirst($envoi['statut'] ?? '—')];
                        @endphp
                        <tr>
                            <td>
                            ...
                            <td><span class="badge {{ $envoiBadgeClass }}">{{ $envoiBadgeLabel }}</span></td>
